...
def generate_purchase_orders():
    ...
    po_df.to_sql('purchase_orders', engine, if_exists='replace', index=False)
    po_items_df.to_sql('purchase_order_items', engine, if_exists='replace', index=False)
...
def generate_quality_incidents():
    ...
    incidents_df.to_sql('quality_incidents', engine, if_exists='replace', index=False)
...
def generate_inventory_snapshots():
    ...
    snapshots_df.to_sql('inventory_snapshots', engine, if_exists='replace', index=False)
...
def generate_financial_summaries():
    ...
    payables_df.to_sql('payables_summary', engine, if_exists='replace', index=False)
    receivables_df.to_sql('receivables_summary', engine, if_exists='replace', index=False)
